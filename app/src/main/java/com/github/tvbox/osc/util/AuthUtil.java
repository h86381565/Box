...
public class AuthUtil {
    ...
    public static String getDeviceId(Context ctx) {
        try {
            ...
            return id!=null? id.toUpperCase() : "UNKNOWN_DEVICE";
        } catch(Exception e){ return "UNKNOWN_DEVICE"; }
    }
    public static String genCode(String deviceId){ return md5(deviceId+SECRET).substring(0,8).toUpperCase(); }
    public static boolean isActivated(Context ctx){
        ...
        try{ return Hawk.get("is_vip_activated", false); }catch(Exception e){ return true; }
    }
    public static boolean isActivated(){ try{ return Hawk.get("is_vip_activated", false);}catch(Exception e){return false;}}
    ...
    public static void saveActivated(){ try{ Hawk.put("is_vip_activated", true);}catch(Exception ignore){}}
