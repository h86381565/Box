...
public class HomeActivity extends BaseActivity {
    ...
    private void initView() {
                ...
                public void onItemPreSelected(TvRecyclerView tvRecyclerView, View view, int position) {
                    if (view!= null &&!HomeActivity.this.isDownOrUp) {
                        try {
                            ...
                            View f = view.findViewById(R.id.tvFilter);
                            if (f!= null) f.setVisibility(View.GONE);
                        } catch (Exception ignore) {}
                    }
                }
        ...
        if (tvWifi!= null) tvWifi.setOnClickListener(view->{ try { startActivity(new Intent(Settings.ACTION_WIFI_SETTINGS)); }catch (Exception ignored){} });
        if (tvFind!= null) tvFind.setOnClickListener(view->{ jumpActivity(SearchActivity.class); });
        if (tvStyle!= null) tvStyle.setOnClickListener(view->{ try {
            Hawk.put(HawkConfig.HOME_REC_STYLE,!Hawk.get(HawkConfig.HOME_REC_STYLE, false));
            if (Hawk.get(HawkConfig.HOME_REC_STYLE, false)) {
                if (UserFragment.tvHotListForGrid!= null) UserFragment.tvHotListForGrid.setVisibility(View.VISIBLE);
                if (UserFragment.tvHotListForLine!= null) UserFragment.tvHotListForLine.setVisibility(View.GONE);
                Toast.makeText(HomeActivity.this, getString(R.string.hm_style_grid), Toast.LENGTH_SHORT).show();
            } else {
                if (UserFragment.tvHotListForGrid!= null) UserFragment.tvHotListForGrid.setVisibility(View.GONE);
                if (UserFragment.tvHotListForLine!= null) UserFragment.tvHotListForLine.setVisibility(View.VISIBLE);
                Toast.makeText(HomeActivity.this, getString(R.string.hm_style_line), Toast.LENGTH_SHORT).show();
            }
        } catch (Exception ex) {} });
        if (tvDraw!= null) tvDraw.setOnClickListener(view->{ jumpActivity(AppsActivity.class); });
        if (tvMenu!= null) tvMenu.setOnClickListener(view->{ jumpActivity(SettingActivity.class); });
        if (tvMenu!= null) tvMenu.setOnLongClickListener(view->{ startActivity(new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Uri.fromParts("package", getPackageName(), null))); return true; });
        if (tvDate!= null) tvDate.setOnClickListener(view->{ try { startActivity(new Intent(Settings.ACTION_DATE_SETTINGS)); } catch (Exception ignore) {} });
    ...
    private void initViewModel() {
        ...
        sourceViewModel.sortResult.observe(this, absXml -> {
                ...
                if (HomeShow && tvName!= null) { if (home!= null && home.getName()!= null &&!home.getName().isEmpty()) tvName.setText(home.getName()); tvName.clearAnimation(); }
        });
    }
    private boolean dataInitOk = false;
    private boolean jarInitOk = false;
    boolean isNetworkAvailable() { try { ConnectivityManager cm = (ConnectivityManager) getSystemService(CONNECTIVITY_SERVICE); NetworkInfo activeNetworkInfo = cm.getActiveNetworkInfo(); return activeNetworkInfo!= null && activeNetworkInfo.isConnectedOrConnecting(); } catch (Exception e) { return true; } }
    ...
    @Override public void onBackPressed() {
        ...
        try {
            ...
            if (baseLazyFragment instanceof GridFragment) {
                ...
                UserFragment.tvHotListForGrid.scrollToPosition(0); if (this.mGridView!= null) this.mGridView.setSelection(0);
            } else { doExit(); }
    ...
    @Override protected void onResume() {
        ...
        SourceBean home = ApiConfig.get().getHomeSourceBean();
        try {
            if (Hawk.get(HawkConfig.HOME_SHOW_SOURCE, false)) { if (home!= null && home.getName()!= null &&!home.getName().isEmpty() && tvName!= null) { tvName.setText(home.getName()); tvName.clearAnimation(); } } else { if (tvName!= null) tvName.setText(R.string.app_name); }
    ...
    private void showFilterIcon(int count) { try { if (currentView == null) return; View v = currentView.findViewById(R.id.tvFilter); if (v == null) return; v.setVisibility(View.VISIBLE); ImageView imgView = currentView.findViewById(R.id.tvFilter); if (imgView!= null) imgView.setColorFilter(count > 0? this.getThemeColor() : Color.WHITE); } catch (Exception ignore) {} }
    ...
    private void changeTop(boolean hide) {
        try {
            ...
            if (hide && topHide == 0) {
                ...
                animatorSet.setDuration(250); animatorSet.start(); return;
            }
            if (!hide && topHide == 1) {
                ...
                animatorSet.setDuration(250); animatorSet.start();
            }
        } catch (Exception ignore) {}
    }
